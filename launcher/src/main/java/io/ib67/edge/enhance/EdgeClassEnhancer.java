...
public class EdgeClassEnhancer implements Opcodes {
    protected static final String ANNOTATION_RULE_PATH = System.getProperty("edge.launcher.annotationRules");
    protected static final boolean VERBOSE = Boolean.getBoolean("edge.launcher.printFoundElements");
