...
package io.ib67.edge.script.exception;
...
public class ContextInitException extends Exception{
    ...
    protected ContextInitException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
